...
export interface Notification {
  id: string;
  user_id: string;
  type: 'follow' | 'like' | 'comment' | 'message' | 'family_invitation' | 'family_invitation_accepted' | 'story_like' | 'mention' | 'collab_request' | 'collab_accepted' | 'family_connection_request';
  actor_id: string;
  post_id: string | null;
